    ...
    <>
      ...
      {isCurrentlyConnected && (
        <>
          ...
          <button onClick={disconnectFromNetwork} disabled={isDisconnecting}>
      ...
      >
        {isDisconnecting ? 'Force Disconnecting...' : 'Force Disconnect'}
      </button>
        ...
        <>
          ...
          {!deviceInfo ? (
            ...
            <p>
              ...
              <br />
              <span>Please wait while we discover available WiFi networks</span>
            </p>
          ) : (
            <p>
              No networks found
